...
export default function NoSoftware() {
  return (
    <div className="flex flex-col items-center justify-center text-center py-20 px-4 bg-white dark:bg-gray-800 rounded-2xl shadow-md">
      ...
      <h2 className="text-2xl font-semibold text-gray-700 dark:text-white mb-2">No Softwares</h2>
      <p className="text-gray-500 dark:text-gray-400 max-w-sm">
        It looks like there are no software created yet. Once Sowftwares are created, they will appear here.
      </p>
    </div>
  );
}